...
HashTable.prototype.set = function(key, value) {
  ...
  // Calculate length of the hash table object
  let counter = Object.keys(this.storage).length;
  
  // Check if occupied capacity of hash table is greater than 75%. If so, rehash all items 
  if (counter/this.Size > .75) {
    this.SIZE *= 2;
    for (prop in this.storage) {
      // Iterate through array and rehash key/value pairs
    } }
