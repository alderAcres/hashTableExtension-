...
// meinHash.remove('brwill');
// meinHash.remove('briell');
// meinHash.remove('brilrl');
// meinHash.remove('briltl');
// meinHash.remove('tbrill');
// meinHash.remove('btrill');
// meinHash.remove('br4tittll');
// meinHash.remove('brt5ittll');
// meinHash.remove('brtitjtll');
// meinHash.remove('brtithtll');
// meinHash.remove('brtithjtll');
// meinHash.remove('brtiasdfttll');
// console.log(meinHash.storage.length);
// let out = meinHash.get('britll');
// out
