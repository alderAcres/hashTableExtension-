...
HashTable.prototype.set = function(key, value) {
  ...
  // check if counter is >= 75%
    // if true, do the following:
    // assign oldStorage to this.storage
    // double this.size
    // reset counter to 0
    // reassign this.storage to new array with new size
    // iterate through old storage
      // check if bucket is an object
      // if true, iterate through the bucket object
      // recursively call this.set with each [key, value]
  // after all these are done, this function will go through the 2nd half...
  //... to store the latest [key, value] that causes this rehash to occur
...
console.log(hashTable.set('a', 10));
console.log(hashTable.set('al', 12));
console.log(hashTable.set('k', 11));
console.log(hashTable.set('b', 10));
console.log(hashTable.set('c', 12));
console.log(hashTable.set('d', 11));
console.log(hashTable.set('e', 10));
console.log(hashTable.set('f', 12));
console.log(hashTable.set('g', 11));
console.log(hashTable.set('h', 10));
console.log(hashTable.set('i', 12));
console.log(hashTable.set('j', 11));
// console.log(hashTable.set('l', 11));
