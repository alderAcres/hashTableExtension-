...
HashTable.prototype.set = function(key, value) {
  ...
  // check if adding a new item will push number of stored items to over 75% of hash table size
  if (this.items + 1 / this.SIZE > 0.75) {
    const prevTable = this.storage;
    const prevSize = this.SIZE;
    const newTable = new HashTable(prevSize * 2)
  }
...
HashTable.prototype.get = function(key) {
  // if key not provided, return undefined
