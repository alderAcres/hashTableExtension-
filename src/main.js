...
HashTable.prototype.set = function (key, value) {
  ...
  // Check if object is present in index
  if (!this.storage[index]) this.storage[index] = {};

  // Store key value pair in index
...
hash.set('meh', 3);
console.log(hash);
console.log(hash.get('z'));
console.log(hash);
console.log(hash.remove('z'));
console.log(hash);
