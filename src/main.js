...
myHashTable.set('pie', 100);
console.log(myHashTable);
console.log('get my pie from hash table', myHashTable.get('pie'));
console.log(('remove banana', myHashTable.remove('banana')));
console.log(('hash table after remove banana', myHashTable));
// Do not remove!!
