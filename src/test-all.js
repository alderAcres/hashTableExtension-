...
//
// const instanceHashTable = new HashTable();
//
// const test1 = () => {
//   instanceHashTable.set('benjamin', 22);
//   instanceHashTable.set('benjamin1', 22);
//   instanceHashTable.set('benjamin2', 22);
//   instanceHashTable.set('benjamin3', 22);
//   instanceHashTable.set('benjamin4', 22);
//   instanceHashTable.set('benjamin5', 22);
// };
